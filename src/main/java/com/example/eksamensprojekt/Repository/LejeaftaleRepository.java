...
import com.example.eksamensprojekt.Model.Lejeaftale;
...
public class LejeaftaleRepository {
    ...
    public void addLejeaftale(Lejeaftale l){
        String sql ="INSERT INTO lejeaftale(lejeaftale_id, kunde_nr,stelnummer,start_dato,slut_dato,pris,afhentningsted,lejeaftaleStatus) VALUES(?,?,?,?,?,?,?,?) ";
        template.update(sql,l.getLejeaftale_id(),l.getKunde_nr(),l.getStelnummer(),l.getStart_dato(),l.getSlut_dato(),l.getPris(),l.getAfhentningsted(),l.getLejeaftaleStatus());
    ...
    public void updateLejeaftale(Lejeaftale l){
        ...
        template.update(sql,l.getStart_dato(),l.getSlut_dato(),l.getPris(),l.getLejeaftale_id(),l.getPris(),l.getAfhentningsted());
        bilRepository.updateBilPris(l.getStelnummer(), l.getPris());
